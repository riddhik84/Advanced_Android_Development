...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter implements GoogleApiClient.ConnectionCallbacks {
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            for (int i = 0; i < weatherArray.length(); i++) {
                ...
                //rkakadia: watchface sync support
                if (i == 0) {
                    Log.d(LOG_TAG, "rkakadia weather data synced from web " + "high: " + high + " low: " + low + " weatherId: " +
                            weatherId);
    ...
    public void onConnected(@Nullable Bundle bundle) {
        Log.d(LOG_TAG, "rkakadia: wearable onConnected");
    ...
    public void onConnectionSuspended(int i) {
        Log.d(LOG_TAG, "rkakadia: wearable onConnectionSuspended");
    ...
    private void sendDataToWearable(final double high, final double low, int weatherId) {
        ...
        handler.post(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(getContext(), "high:" + high + ",low" + low, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        pendingResult.setResultCallback(new ResultCallback<DataApi.DataItemResult>() {
            ...
            public void onResult(@NonNull DataApi.DataItemResult dataItemResult) {
                if (dataItemResult.getStatus().isSuccess()) {
                    Log.d(LOG_TAG, "rkakadia on result success");
                } else {
                    Log.d(LOG_TAG, "rkakadia on result failed");
                }
            }
        });
    }
